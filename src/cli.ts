...
function printHelp(): void {
  ...
  console.log("    install            Register the plugin in opencode.json(c)")
  console.log("    install --global   Global (~/.config/opencode)")
  console.log("    install --project  Project (.opencode/opencode.json)")
  console.log("    install --compact / --no-compact")
  console.log("    install --minified / --no-minified")
  console.log("    doctor             Check OpenCode + opencode.json registration")
